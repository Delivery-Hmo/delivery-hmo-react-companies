...
const CreateUserBranchOfficeDeliveryMan = () => {
    ...
    const onFinish = async () => {
        try {
            ...
            const { id, uid, name, email, phone, description, password, repeatPassword, active } = deliveryMan
            ...
            if (type === "update") {
                ...
                await put(`userBranchOfficeDeliveryMan/${type}`, {
                ...
                await post(`userBranchOfficeDeliveryMan/${type}`, {
                    id, uid, name, email, phone, description, password, active
                });
            }
        } catch (error) {
